...
Partial Class WebForms_GestantesList
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        BindHelper.SubTablasUIL.BindToListControlPorId_Tabla(ddl_Tipo_Declaracion, 76, New ListItem("Seleccione", 0))
        ...
        Dim ListGestantes As List(Of PersonasBrl) = Session("ListGestantes")

        'si no hay una variable de sesión con la lista.
        If ListGestantes Is Nothing Or Request.QueryString.Item("Refrescar") = 1 Then
            ListGestantes = PersonasBrl.CargarPorId_Embarazada(0) ' 19 es si en las subtablas.
            Session("ListGestantes") = ListGestantes
        End If

        Rg_Listado.DataSource = Session("ListGestantes")
        Rg_Listado.DataBind()
    ...
    Protected Sub Rg_Listado_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles Rg_Listado.SelectedIndexChanged
        ...
        Response.Redirect("Gestantes.aspx?Editar=1&ID=" & item("id").Text)
    End Sub
    ...
    Protected Sub btn_limpiar_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles btn_limpiar.Click
        Dim ListGestantes As New List(Of PersonasBrl)
        Session.Remove("ListGestantes")
        ListGestantes = PersonasBrl.CargarPorId_Embarazada(0)
        Session("ListGestantes") = ListGestantes
    ...
    Protected Sub btn_Procesar_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles btn_Procesar.Click, btn_actualizar.Click
        ...
        End If
        ListGestantes = PersonasBrl.CargarPorId_EmbarazadaBusqueda(19, Grupos, txt_identificacion.Text, txt_nombre.Text, ddl_regional.SelectedValue, wfechainicio, wfechafinal, ddl_Tipo_Declaracion.SelectedValue, ddl_Regimen_Salud.SelectedValue, ddl_Lactando.SelectedValue)
        Session("ListGestantes") = ListGestantes
        Rg_Listado.DataSource = Session("ListGestantes")
        Rg_Listado.DataBind()
