...
Partial Class WebForms_EntradasAjustes
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Dim ListDetalleEntradasAjustes As List(Of Entradas_DetalleBrl) = Session("ListDetalleEntradasAjustes")
        ...
        If Request.QueryString.Item("Editar") = 1 Then
            ...
            ListDetalleEntradasAjustes = objEntradas.Entradas_Detalle
            Session("ListDetalleEntradasAjustes") = ListDetalleEntradasAjustes

            Btn_Nuevo_Producto.Enabled = True

            Rg_Listado.DataSource = Session("ListDetalleEntradasAjustes")
            Rg_Listado.DataBind()
        End If
    ...
    Private Sub btnGuardar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnGuardar.Click
        ...
        Try
            ID = Grabar()
            Response.Redirect("EntradasAjustes.aspx?Editar=1&Mensaje=1&ID=" & ID)
    ...
    Private Sub btnGuardarOtro_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnGuardarOtro.Click
        ...
        Try
            Grabar()
            Response.Redirect("EntradasAjustes.aspx?Mensaje=1")
        Catch ex As Exception
            lblMensaje.Text = ex.Message
            lblMensaje.Visible = True
        End Try
    ...
    Private Function Grabar() As Int32
        ...
        Else
            ...
            objEntradas.Id_Tipo_Entrada = 3919 ' por codigo de subtablas Ajustes
        End If
    ...
    Protected Sub btn_nuevo_ProductoClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles Btn_Nuevo_Producto.Click
    ...
    Protected Sub btn_limpiar_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btn_limpiar.Click
        ...
        lblIdProducto.Text = ""
        rdpfechaVence.SelectedDate = Nothing
        '
    ...
    Protected Sub Rg_Listado_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles Rg_Listado.SelectedIndexChanged
        ...
        Try
            rdpfechaVence.SelectedDate = objproducto.Fecha_Vencimiento
        Catch ex As Exception
            rdpfechaVence.SelectedDate = Nothing
        End Try
    ...
    Public Sub subeliminarproducto(ByVal sender As Object, ByVal e As GridCommandEventArgs)
        Try
            ...
            Dim ListDetalleEntradasAjustes As List(Of Entradas_DetalleBrl)
            ListDetalleEntradasAjustes = Entradas_DetalleBrl.CargarPorId_Entrada(Request.QueryString.Item("Id"))
            Session("ListDetalleEntradasAjustes") = ListDetalleEntradasAjustes
            Rg_Listado.DataSource = Session("ListDetalleEntradasAjustes")
            Rg_Listado.DataBind()
    ...
    Public Sub subCommandItemAsignacion(ByVal sender As Object, ByVal e As DataGridCommandEventArgs) Handles dgAsignacion.ItemCommand
        Select Case e.CommandName
            Case "Edit"
    ...
    Protected Sub Button1_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        ProductoDetalle.Valor_Unitario = txtValor_Unitario.Text
        Try
            ProductoDetalle.Fecha_Vencimiento = rdpfechaVence.SelectedDate
        Catch ex As Exception
    ...
    Protected Sub btnEliminar_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnEliminar.Click
        Try
            ...
            Response.Redirect("EntradasAjustesList.aspx?Refrescar=1")
        Catch ex As Exception
            lblMensaje.Text = ex.Message
            lblMensaje.Visible = True
        End Try
    ...
    Protected Sub btn_nuevo_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles btn_nuevo.Click
        Response.Redirect("../webforms/EntradasAjustes.aspx")
    End Sub
    ...
    Protected Sub btn_cerrar_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles btn_cerrar.Click
        Response.Redirect("../webforms/EntradasAjustesList.aspx")
    End Sub

    Protected Sub btn_actualizar_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles btn_actualizar.Click
        If Request.QueryString.Item("Id") > 0 Then
            Response.Redirect("../webforms/EntradasAjustes.aspx?Editar=1&Id=" + Request.QueryString.Item("Id"))
        Else
