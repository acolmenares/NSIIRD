...
Partial Class WebForms_EntradasDonaciones
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Dim ListDetalleEntradasDonaciones As List(Of Entradas_DetalleBrl) = Session("ListDetalleEntradasDonaciones")
        ...
        If Request.QueryString.Item("Editar") = 1 Then
            ...
            ListDetalleEntradasDonaciones = objEntradas.Entradas_Detalle
    ...
    Private Sub btnGuardar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnGuardar.Click
        ...
        Try
            ID = Grabar()
            Response.Redirect("EntradasDonaciones.aspx?Editar=1&Mensaje=1&ID=" & ID)
    ...
    Private Sub btnGuardarOtro_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnGuardarOtro.Click
        ...
        Try
            Grabar()
            Session.Remove("ListDetalleEntradasDonaciones")
    ...
    Protected Sub btn_cerrar_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles btn_cerrar.Click
        Response.Redirect("../webforms/EntradasDonacionesList.aspx")
    End Sub

    Protected Sub btn_actualizar_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles btn_actualizar.Click
        If Request.QueryString.Item("Id") > 0 Then
            Response.Redirect("../webforms/EntradasDonaciones.aspx?Editar=1&Id=" + Request.QueryString.Item("Id"))
        Else
