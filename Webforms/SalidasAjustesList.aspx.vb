...
Partial Class WebForms_SalidasAjustesList
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Dim ListSalidas As List(Of SalidasBrl) = Session("ListSalidasAjustes")

        'si no hay una variable de sesión con la lista.
        If ListSalidas Is Nothing Or Request.QueryString.Item("Refrescar") = 1 Then
            ListSalidas = SalidasBrl.CargarPorId_Tipo_Salida(0)  ' Ajuste de Inventario 
            Session("ListSalidasAjustes") = ListSalidas
        End If

        Rg_Listado.DataSource = Session("ListSalidasAjustes")
        Rg_Listado.DataBind()
    ...
    Protected Sub Rg_Listado_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles Rg_Listado.SelectedIndexChanged
        ...
        Response.Redirect("SalidasAjustes.aspx?Editar=1&ID=" & item("id").Text)
    End Sub
    ...
    Protected Sub btn_actualizar_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles btn_actualizar.Click
        Response.Redirect("../webforms/SalidasAjustesList.aspx?Refrescar=1")
    End Sub
    ...
    Protected Sub btn_limpiar_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles btn_limpiar.Click
        Dim ListSalidasAjustes As New List(Of SalidasBrl)
        Session.Remove("ListSalidasAjustes")
        ListSalidasAjustes = SalidasBrl.CargarPorId_Regional(0)
        Session("ListSalidasAjustes") = ListSalidasAjustes
        txt_Numero.Text = ""
    ...
    Protected Sub btn_Procesar_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles btn_Procesar.Click
        ...
        Dim ListSalidasAjustes As New List(Of SalidasBrl)
        ListSalidasAjustes = SalidasBrl.CargarPorBusqueda(ddl_regional.SelectedValue, ddl_Bodega.SelectedValue, ddl_Productos.SelectedValue, wfechainicio, wfechafinal, txt_Numero.Text, 3568)
        Session("ListSalidasAjustes") = ListSalidasAjustes
