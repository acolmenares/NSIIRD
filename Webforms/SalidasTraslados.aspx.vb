...
Partial Class WebForms_SalidasTraslados
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        BindHelper.SubTablasUIL.BindToListControlPorId_Tabla(ddl_RegionalEnvio, 72, New ListItem("Seleccione", 0))
        ...
        Dim ListDetalleTraslados As List(Of Salidas_DetalleBrl) '= Session("ListDetalleTraslados")
        ListDetalleTraslados = Salidas_DetalleBrl.CargarPorId_Salida(0)
        Session("ListDetalleTraslados") = ListDetalleTraslados
        ...
        If Request.QueryString.Item("Editar") = 1 Then
            ...
            If ddl_RegionalEnvio.Items.FindByValue(objSalidas.Id_Reg_Grupo) IsNot Nothing Then ddl_RegionalEnvio.SelectedValue = objSalidas.Id_Reg_Grupo
            ...
            ListDetalleTraslados = objSalidas.Salidas_Detalle
            Session("ListDetalleTraslados") = ListDetalleTraslados
        ...
        Rg_Listado.DataSource = Session("ListDetalleTraslados")
        Rg_Listado.DataBind()
    ...
    Private Sub btnGuardar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnGuardar.Click
        ...
        Try
            ID = Grabar()
            Response.Redirect("SalidasTraslados.aspx?Editar=1&Mensaje=1&ID=" & ID)
    ...
    Private Sub btnGuardarOtro_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnGuardarOtro.Click
        ...
        Try
            Grabar()
            Response.Redirect("SalidasTraslados.aspx?Mensaje=1")
        Catch ex As Exception
            lblMensaje.Text = ex.Message
            lblMensaje.Visible = True
        End Try
    ...
    Private Function Grabar() As Int32
        ...
        Else
            ...
            objsalidas.Id_Tipo_Salida = 3275 ' por codigo de subtablas traslados
        ...
        objsalidas.Id_Reg_Grupo = ddl_RegionalEnvio.SelectedValue
    ...
    Protected Sub btn_nuevo_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btn_nuevo.Click, btn_nuevo_producto.Click
    ...
    Protected Sub btn_limpiar_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btn_limpiar.Click
        ...
        Session("EntradasTraslados") = ListEntradasDetalleSalidas
        dgEntradas.DataSource = Session("EntradasTraslados")
        dgEntradas.DataBind()
        '
    ...
    Public Sub subeliminarproducto(ByVal sender As Object, ByVal e As GridCommandEventArgs)
        Try
            ...
            Dim ListDetalleTraslados As List(Of Salidas_DetalleBrl)
            ListDetalleTraslados = Salidas_DetalleBrl.CargarPorId_Salida(Request.QueryString.Item("Id"))
            Session("ListDetalleTraslados") = ListDetalleTraslados
            Rg_Listado.DataSource = Session("ListDetalleTraslados")
            Rg_Listado.DataBind()
    ...
    Public Sub subeliminarEntradas(ByVal sender As Object, ByVal e As DataGridCommandEventArgs)
        ...
        Dim ListEntradasDetalleSalidas As New List(Of Salidas_Detalle_EntradasBrl)
        ListEntradasDetalleSalidas = CType(Session("EntradasTraslados"), List(Of Salidas_Detalle_EntradasBrl))
    ...
    Protected Sub Rg_Listado_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles Rg_Listado.SelectedIndexChanged
        ...
        Session("EntradasTraslados") = objproducto.Salidas_Detalle_Entradas
        dgEntradas.DataSource = Session("EntradasTraslados")
        dgEntradas.DataBind()
    ...
    Protected Sub Button3_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btn_GuardarAsignacion.Click
        ...
        ListEntradas = CType(Session("EntradasTraslados"), List(Of Salidas_Detalle_EntradasBrl))
        ...
        If lblIdEntrada.Text = "" Then
            ...
            objtempasignacion.Cantidad = Me.txt_cantidadentrada.Text
        ...
        Else
            ...
            For Each fila As Salidas_Detalle_EntradasBrl In ListEntradas
                If fila.ID = Val(lblIdEntrada.Text) Then
                    fila.Cantidad = txt_cantidadentrada.Text
        ...
        '
        Session("EntradasTraslados") = ListEntradas
        dgEntradas.DataSource = Session("EntradasTraslados")
        dgEntradas.DataBind()
        btn_nuevaentrada_Click(Nothing, Nothing)
    End Sub
    ...
    Protected Sub btn_GuardarProducto_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btn_GuardarProducto.Click
        ...
        End If
        ProductoDetalle.Cantidad = txtCantidad.Text
        ...
        Session("ListDetalleTraslados") = ListDetalleSalidas
    ...
    Protected Sub btnEliminar_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnEliminar.Click
        Try
            ...
            Response.Redirect("SalidasTrasladosList.aspx?Refrescar=1")
        Catch ex As Exception
            lblMensaje.Text = ex.Message
            lblMensaje.Visible = True
        End Try
    ...
    Protected Sub btn_nuevo_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles btn_nuevo.Click
        Response.Redirect("../webforms/SalidasTraslados.aspx")
    End Sub
    ...
    Protected Sub btn_cerrar_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles btn_cerrar.Click
        Response.Redirect("../webforms/SalidasTrasladosList.aspx")
    End Sub

    Protected Sub btn_actualizar_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles btn_actualizar.Click
        If Request.QueryString.Item("Id") > 0 Then
            Response.Redirect("../webforms/SalidasTraslados.aspx?Editar=1&Id=" + Request.QueryString.Item("Id"))
        Else
