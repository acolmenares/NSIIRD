...
Partial Class WebForms_Personas_Regimen_SaludList
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Dim ListRegimenSalud As List(Of PersonasBrl) = Session("ListRegimenSalud")
        ...
        If ListRegimenSalud Is Nothing Or Request.QueryString.Item("Refrescar") = 1 Then
            ListRegimenSalud = PersonasBrl.CargarPorId_Genero(0) ' Carga en blanco
            Session("ListRegimenSalud") = ListRegimenSalud
        End If
    ...
    Protected Sub Rg_Listado_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles Rg_Listado.SelectedIndexChanged
        ...
        Response.Redirect("Personas_Regimen_Salud.aspx?Editar=1&ID=" & item("id").Text)
    End Sub
    ...
    Protected Sub btn_limpiar_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles btn_limpiar.Click
        Dim ListRegimenSalud As New List(Of PersonasBrl)
        Session.Remove("ListRegimenSalud")
        ListRegimenSalud = PersonasBrl.CargarPorId_Genero(0)
        Session("ListRegimenSalud") = ListRegimenSalud
    ...
    Protected Sub btn_Procesar_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles btn_Procesar.Click, btn_actualizar.Click
        ...
        End If
        Dim ListRegimenSalud As New List(Of PersonasBrl)
        ListRegimenSalud = PersonasBrl.CargarPorFiltroRegimenSalud(ddl_grupo.SelectedValue, txt_identificacion.Text, txt_nombre.Text, ddl_regional.SelectedValue, wfechainicio, wfechafinal, ddl_tipodeclarante.SelectedValue, ddl_LugarEntrega.SelectedValue, chk_pendiente.Checked)
        Session("ListRegimenSalud") = ListRegimenSalud
        Rg_Listado.DataSource = Session("ListRegimenSalud")
        Rg_Listado.DataBind()
    ...
    Protected Sub ddl_LugarEntrega_SelectedIndexChanged(sender As Object, e As System.EventArgs) Handles ddl_LugarEntrega.SelectedIndexChanged
