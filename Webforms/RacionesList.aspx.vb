...
Partial Class WebForms_RacionesList
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Dim ListRaciones As List(Of RacionesBrl) = Session("ListRaciones")

        'si no hay una variable de sesión con la lista.
        If ListRaciones Is Nothing Or Request.QueryString.Item("Refrescar") = 1 Then
            ListRaciones = RacionesBrl.CargarTodos()
            Session("ListRaciones") = ListRaciones
        End If

        Rg_Listado.DataSource = Session("ListRaciones")
        Rg_Listado.DataBind()
    ...
    Protected Sub Rg_Listado_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles Rg_Listado.SelectedIndexChanged
        ...
        Response.Redirect("Raciones.aspx?Editar=1&ID=" & item("id").Text)
    End Sub
    ...
    Protected Sub btn_actualizar_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles btn_actualizar.Click
        Response.Redirect("../webforms/RacionesList.aspx?Refrescar=1")
    End Sub
End Class
