...
Partial Class WebForms_EntradasAjustesList
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Dim ListEntradas As List(Of EntradasBrl) = Session("ListEntradasAjustes")

        'si no hay una variable de sesión con la lista.
        If ListEntradas Is Nothing Or Request.QueryString.Item("Refrescar") = 1 Then
            ListEntradas = EntradasBrl.CargarPorId_Tipo_Entrada(0)  ' Ajustes
            Session("ListEntradasAjustes") = ListEntradas
        End If

        Rg_Listado.DataSource = Session("ListEntradasAjustes")
        Rg_Listado.DataBind()
    ...
    Protected Sub Rg_Listado_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles Rg_Listado.SelectedIndexChanged
        ...
        Response.Redirect("EntradasAjustes.aspx?Editar=1&ID=" & item("id").Text)
    End Sub
    ...
    Protected Sub btn_actualizar_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles btn_actualizar.Click
        Response.Redirect("../webforms/EntradasAjustesList.aspx?Refrescar=1")
    End Sub
    ...
    Protected Sub btn_limpiar_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles btn_limpiar.Click
        Dim ListEntradasAjustes As New List(Of EntradasBrl)
        Session.Remove("ListEntradasAjustes")
        ListEntradasAjustes = EntradasBrl.CargarPorId_Regional(0)
        Session("ListEntradasAjustes") = ListEntradasAjustes
        txt_Numero.Text = ""
    ...
    Protected Sub btn_Procesar_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles btn_Procesar.Click
        ...
        Listentradas = EntradasBrl.CargarPorBusqueda(ddl_regional.SelectedValue, ddl_Bodega.SelectedValue, ddl_Productos.SelectedValue, wfechainicio, wfechafinal, txt_Numero.Text, 3919)
        Session("ListEntradasAjustes") = Listentradas
        Rg_Listado.DataSource = Session("ListEntradasAjustes")
        Rg_Listado.DataBind()
    End Sub
