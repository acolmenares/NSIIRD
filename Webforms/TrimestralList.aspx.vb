...
Partial Class WebForms_TrimestralList
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Dim ListTrimestral As List(Of TrimestralBrl) = Session("ListTrimestral")

        'si no hay una variable de sesión con la lista.
        If ListTrimestral Is Nothing Or Request.QueryString.Item("Refrescar") = 1 Then
            ListTrimestral = TrimestralBrl.CargarTodos()
            Session("ListTrimestral") = ListTrimestral
        End If

        Rg_Listado.DataSource = Session("ListTrimestral")
        Rg_Listado.DataBind()
    ...
    Protected Sub Rg_Listado_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles Rg_Listado.SelectedIndexChanged
        ...
        Response.Redirect("Trimestral.aspx?Editar=1&ID=" & item("id").Text)
    End Sub
    ...
    Protected Sub btn_actualizar_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles btn_actualizar.Click
        Response.Redirect("../webforms/TrimestralList.aspx?Refrescar=1")
    End Sub
End Class
