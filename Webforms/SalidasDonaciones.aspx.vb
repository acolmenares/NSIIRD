...
Partial Class WebForms_SalidasDonaciones
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Dim ListDetalleDonaciones As List(Of Salidas_DetalleBrl) = Session("ListDetalleDonaciones")
        ...
        If Request.QueryString.Item("Editar") = 1 Then
            ...
            ListDetalleDonaciones = objSalidas.Salidas_Detalle
            Session("ListDetalleDonaciones") = ListDetalleDonaciones
            btn_nuevo_producto.Enabled = True
            Rg_Listado.DataSource = Session("ListDetalleDonaciones")
            Rg_Listado.DataBind()
    ...
    Private Sub btnGuardar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnGuardar.Click
        ...
        Try
            ID = Grabar()
            Response.Redirect("SalidasDonaciones.aspx?Editar=1&Mensaje=1&ID=" & ID)
    ...
    Private Sub btnGuardarOtro_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnGuardarOtro.Click
        ...
        Try
            Grabar()
            Response.Redirect("SalidasDonaciones.aspx?Mensaje=1")
        Catch ex As Exception
            lblMensaje.Text = ex.Message
            lblMensaje.Visible = True
        End Try
    ...
    Private Function Grabar() As Int32
        ...
        Else
            ...
            objsalidas.Id_Tipo_Salida = 3838 ' por codigo de subtablas donaciones
    ...
    Protected Sub btn_limpiar_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btn_limpiar.Click
        ...
        Session("EntradasDonaciones") = ListEntradasDetalleSalidas
        dgEntradas.DataSource = Session("EntradasDonaciones")
        dgEntradas.DataBind()
        '
    ...
    Public Sub subeliminarproducto(ByVal sender As Object, ByVal e As GridCommandEventArgs)
        Try
            ...
            Dim ListDetalleDonaciones As List(Of Salidas_DetalleBrl)
            ListDetalleDonaciones = Salidas_DetalleBrl.CargarPorId_Salida(Request.QueryString.Item("Id"))
            Session("ListDetalleDonaciones") = ListDetalleDonaciones
            Rg_Listado.DataSource = Session("ListDetalleDonaciones")
            Rg_Listado.DataBind()
    ...
    Public Sub subeliminarEntradas(ByVal sender As Object, ByVal e As DataGridCommandEventArgs)
        ...
        Dim ListEntradasDetalleSalidas As New List(Of Salidas_Detalle_EntradasBrl)
        ListEntradasDetalleSalidas = CType(Session("EntradasDonaciones"), List(Of Salidas_Detalle_EntradasBrl))
    ...
    Protected Sub Rg_Listado_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles Rg_Listado.SelectedIndexChanged
        ...
        Session("EntradasDonaciones") = objproducto.Salidas_Detalle_Entradas
        dgEntradas.DataSource = Session("EntradasDonaciones")
        dgEntradas.DataBind()
    ...
    Protected Sub Button3_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btn_GuardarAsignacion.Click
        ...
        ListEntradas = CType(Session("EntradasDonaciones"), List(Of Salidas_Detalle_EntradasBrl))
        ...
        If lblIdEntrada.Text = "" Then
            ...
            objtempasignacion.Cantidad = Val(Me.txt_cantidadentrada.Text)
        ...
        '
        Session("EntradasDonaciones") = ListEntradas
        dgEntradas.DataSource = Session("EntradasDonaciones")
        dgEntradas.DataBind()
        btn_nuevaentrada_Click(Nothing, Nothing)
    End Sub
    ...
    Protected Sub Button1_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btn_GuardarProducto.Click
        ...
        Session("ListDetalleDonaciones") = ListDetalleSalidas
    ...
    Protected Sub btnEliminar_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnEliminar.Click
        Try
            ...
            Response.Redirect("SalidasDonacionesList.aspx?Refrescar=1")
        Catch ex As Exception
            lblMensaje.Text = ex.Message
            lblMensaje.Visible = True
        End Try
    ...
    Protected Sub btn_nuevo_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles btn_nuevo.Click
        Response.Redirect("../webforms/SalidasDonaciones.aspx")
    End Sub
    ...
    Protected Sub btn_cerrar_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles btn_cerrar.Click
        Response.Redirect("../webforms/SalidasDonacionesList.aspx")
    End Sub

    Protected Sub btn_actualizar_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles btn_actualizar.Click
        If Request.QueryString.Item("Id") > 0 Then
            Response.Redirect("../webforms/SalidasDonaciones.aspx?Editar=1&Id=" + Request.QueryString.Item("Id"))
        Else
            btn_nuevo_Click(sender, e)
        End If
    End Sub

    Protected Sub ddl_Regional_SelectedIndexChanged(ByVal sender As Object, ByVal e As EventArgs) Handles ddl_Regional.SelectedIndexChanged
