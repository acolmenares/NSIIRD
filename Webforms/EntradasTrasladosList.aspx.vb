...
Partial Class WebForms_EntradasTrasladosList
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Dim ListEntradasTraslados As List(Of EntradasBrl) = Session("ListEntradasTraslados")

        'si no hay una variable de sesión con la lista.
        If ListEntradasTraslados Is Nothing Or Request.QueryString.Item("Refrescar") = 1 Then
            ListEntradasTraslados = EntradasBrl.CargarPorId_Tipo_Entrada(0)  ' 3272 Traslados
            Session("ListEntradasTraslados") = ListEntradasTraslados
        End If
    ...
    Protected Sub Rg_Listado_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles Rg_Listado.SelectedIndexChanged
        ...
        Response.Redirect("EntradasTraslados.aspx?Editar=1&ID=" & item("id").Text)
    End Sub
    ...
    Protected Sub btn_limpiar_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles btn_limpiar.Click
        Dim ListEntradasTraslados As New List(Of EntradasBrl)
        Session.Remove("ListEntradasTraslados")
        ListEntradasTraslados = EntradasBrl.CargarPorId_Regional(0)
        Session("ListEntradasTraslados") = ListEntradasTraslados
        txt_Numero.Text = ""
    ...
    Protected Sub btn_Procesar_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles btn_Procesar.Click
        ...
        ListEntradasTraslados = EntradasBrl.CargarPorBusqueda(ddl_regional.SelectedValue, ddl_Bodega.SelectedValue, ddl_Productos.SelectedValue, wfechainicio, wfechafinal, txt_Numero.Text, 3272)
        Session("ListEntradasTraslados") = ListEntradasTraslados
        Rg_Listado.DataSource = Session("ListEntradasTraslados")
        Rg_Listado.DataBind()
    End Sub
