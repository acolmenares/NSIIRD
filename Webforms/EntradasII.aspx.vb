...
Partial Class WebForms_EntradasII
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Dim ListDetalleEntradas As List(Of Entradas_DetalleBrl) = Session("ListDetalleEntradasII")
        ...
        If Request.QueryString.Item("Editar") = 1 Then
            ...
            Session("ListDetalleEntradasII") = ListDetalleEntradas

            Btn_Nuevo_Producto.Enabled = True

            Rg_Listado.DataSource = Session("ListDetalleEntradasII")
            Rg_Listado.DataBind()
        End If
    ...
    Private Sub btnGuardar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnGuardar.Click
        ...
        Try
            ID = Grabar()
            Response.Redirect("EntradasII.aspx?Editar=1&Mensaje=1&ID=" & ID)
    ...
    Private Sub btnGuardarOtro_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnGuardarOtro.Click
        ...
        Try
            Grabar()
            Response.Redirect("EntradasII.aspx?Mensaje=1")
        Catch ex As Exception
            lblMensaje.Text = ex.Message
            lblMensaje.Visible = True
        End Try
    ...
    Private Function Grabar() As Int32
        ...
        objEntradas.Id_Tipo_Entrada = 3281 ' por codigo de subtablas Inventarios Iniciales
    ...
    Public Sub subeliminarproducto(ByVal sender As Object, ByVal e As GridCommandEventArgs)
        Try
            ...
            Session("ListDetalleEntradasII") = ListProductosDetalle
            Rg_Listado.DataSource = Session("ListDetalleEntradasII")
            Rg_Listado.DataBind()
    ...
    Protected Sub btnEliminar_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnEliminar.Click
        Try
            ...
            Response.Redirect("EntradasIIList.aspx?Refrescar=1")
        Catch ex As Exception
            lblMensaje.Text = ex.Message
            lblMensaje.Visible = True
        End Try
    ...
    Protected Sub btn_cerrar_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles btn_cerrar.Click
        Response.Redirect("../webforms/EntradasIIList.aspx")
    End Sub

    Protected Sub btn_actualizar_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles btn_actualizar.Click
        If Request.QueryString.Item("Id") > 0 Then
            Response.Redirect("../webforms/EntradasII.aspx?Editar=1&Id=" + Request.QueryString.Item("Id"))
        Else
