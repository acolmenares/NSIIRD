...
Partial Class WebForms_Personas_EducacionList
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Dim ListEducacion As List(Of PersonasBrl) = Session("ListEducacion")
        ...
        If ListEducacion Is Nothing Or Request.QueryString.Item("Refrescar") = 1 Then
            ListEducacion = PersonasBrl.CargarPorId_Estudia_Actualmente(0) ' Carga en blanco
            Session("ListEducacion") = ListEducacion
        End If
    ...
    Protected Sub Rg_Listado_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles Rg_Listado.SelectedIndexChanged
        ...
        Response.Redirect("Personas_Educacion.aspx?Editar=1&ID=" & item("id").Text)
    End Sub
    ...
    Protected Sub btn_limpiar_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles btn_limpiar.Click
        Dim ListEducacion As New List(Of PersonasBrl)
        Session.Remove("ListEducacion")
        ListEducacion = PersonasBrl.CargarPorId_Estudia_Actualmente(0)
        Session("ListEducacion") = ListEducacion
    ...
    Protected Sub btn_Procesar_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles btn_Procesar.Click, btn_actualizar.Click
        ...
        End If
        Dim ListEducacion As New List(Of PersonasBrl)
        ListEducacion = PersonasBrl.CargarPorFiltroEducacion(ddl_grupo.SelectedValue, txt_identificacion.Text, txt_nombre.Text, ddl_regional.SelectedValue, wfechainicio, wfechafinal, ddl_tipodeclarante.SelectedValue, ddl_LugarEntrega.SelectedValue, chk_pendiente.Checked)
        Session("ListEducacion") = ListEducacion
        Rg_Listado.DataSource = Session("ListEducacion")
        Rg_Listado.DataBind()
    End Sub
