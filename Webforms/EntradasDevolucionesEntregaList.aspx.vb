...
Partial Class WebForms_EntradasDevolucionesEntregaList
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Dim ListEntradasDevolucionesEntregas As List(Of EntradasBrl) = Session("ListEntradasDevolucionesEntregas")

        'si no hay una variable de sesión con la lista.
        If ListEntradasDevolucionesEntregas Is Nothing Or Request.QueryString.Item("Refrescar") = 1 Then
            ListEntradasDevolucionesEntregas = EntradasBrl.CargarPorId_Tipo_Entrada(0)  ' Donantes
            Session("ListEntradasDevolucionesEntregas") = ListEntradasDevolucionesEntregas
        End If

        Rg_Listado.DataSource = Session("ListEntradasDevolucionesEntregas")
        Rg_Listado.DataBind()
    ...
    Protected Sub Rg_Listado_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles Rg_Listado.SelectedIndexChanged
        ...
        Response.Redirect("EntradasDevolucionesEntrega.aspx?Editar=1&ID=" & item("id").Text)
    End Sub
    ...
    Protected Sub btn_nuevo_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles btn_nuevo.Click
        Response.Redirect("../webforms/EntradasDevolucionesEntrega.aspx")
    End Sub

    Protected Sub btn_actualizar_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles btn_actualizar.Click
        Response.Redirect("../webforms/EntradasDevolucionesEntregaList.aspx?Refrescar=1")
    End Sub
    ...
    Protected Sub btn_limpiar_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles btn_limpiar.Click
        Dim ListEntradasDevolucionesEntregas As New List(Of EntradasBrl)
        Session.Remove("ListEntradasDevolucionesEntregas")
        ListEntradasDevolucionesEntregas = EntradasBrl.CargarPorId_Regional(0)
        Session("ListEntradasDevolucionesEntregas") = ListEntradasDevolucionesEntregas
        txt_Numero.Text = ""
    ...
    Protected Sub btn_Procesar_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles btn_Procesar.Click
        ...
        ListEntradasDevolucionesEntregas = EntradasBrl.CargarPorBusqueda(ddl_regional.SelectedValue, ddl_Bodega.SelectedValue, ddl_Productos.SelectedValue, wfechainicio, wfechafinal, txt_Numero.Text, 158)
        Session("ListEntradasDevolucionesEntregas") = ListEntradasDevolucionesEntregas
        Rg_Listado.DataSource = Session("ListEntradasDevolucionesEntregas")
        Rg_Listado.DataBind()
    End Sub
