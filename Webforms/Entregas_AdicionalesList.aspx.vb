...
Partial Class WebForms_Entregas_AdicionalesList
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Dim ListEntregaAdicional As List(Of Entregas_AdicionalesBrl) = Session("ListEntregaAdicional")

        'si no hay una variable de sesión con la lista.
        If ListEntregaAdicional Is Nothing Or Request.QueryString.Item("Refrescar") = 1 Then
            ListEntregaAdicional = Entregas_AdicionalesBrl.CargarTodos()
            Session("ListEntregaAdicional") = ListEntregaAdicional
        End If

        Rg_Listado.DataSource = Session("ListEntregaAdicional")
        Rg_Listado.DataBind()
    ...
    Protected Sub btn_actualizar_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles btn_actualizar.Click
        Response.Redirect("../webforms/Entregas_AdicionalesList.aspx?Refrescar=1")
    End Sub
    ...
    Protected Sub Rg_Listado_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles Rg_Listado.SelectedIndexChanged
        ...
        Response.Redirect("Entregas_Adicionales.aspx?Editar=1&ID=" & item("Id").Text)
    End Sub
    ...
    Public Sub subEliminar(ByVal sender As Object, ByVal e As Telerik.Web.UI.GridCommandEventArgs)
        ...
        Dim objEntrega_Adicional As New Entregas_AdicionalesBrl

        objEntrega_Adicional = Entregas_AdicionalesBrl.CargarPorID(lblId.Text)

        If objEntrega_Adicional.Entregas_Adicionales_Personas.Count > 0 Then
            lbl_Mensaje.Text = "Esta entrega tiene personas Vinculadas. No se puede eliminar !!!!"
            lbl_Mensaje.Visible = True
            Exit Sub
        End If

        objEntrega_Adicional.Eliminar()

        btn_actualizar_Click(Nothing, Nothing)
    End Sub

    Protected Sub btn_nuevo_Click(sender As Object, e As System.Web.UI.ImageClickEventArgs) Handles btn_nuevo.Click
        Response.Redirect("Entregas_Adicionales.aspx")
    End Sub
End Class
