...
Partial Public Class Entradas_OrdenCompraBrl
    ...
    Public Sub Guardar()
        ...
        If (Me.ID = Nothing) Then
            ...
            Me.ID = Entradas_OrdenCompraDAL.Insertar(Id_Entrada_Detalle, Cantidad, Id_OrdenCompra_Detalle, Fecha_Creacion, Id_Usuario_Creacion, Fecha_Modificacion, Id_Usuario_Modificacion, Fecha_Cierre, Cierre)
            RaiseEvent Inserted()
        Else
            RaiseEvent Updating()
            Entradas_OrdenCompraDAL.Actualizar(ID, Id_Entrada_Detalle, Cantidad, Id_OrdenCompra_Detalle, Fecha_Creacion, Id_Usuario_Creacion, Fecha_Modificacion, Id_Usuario_Modificacion, Fecha_Cierre, Cierre)
            RaiseEvent Updated()
        End If
    ...
    Public Sub Eliminar()
        ...
        If Me.ID <> Nothing Then
            ...
            Entradas_OrdenCompraDAL.Eliminar(Me.ID)
