...
Partial Public Class Entradas_DistribucionBrl
    ...
    Public ReadOnly Property detalleysaldo() As String
        Get
            ...
            wcadena = Entradas_Detalle.Entradas.Numero_Entrada.ToString & " Por :" & Cantidad.ToString & " - Salidas : " & Salidas_Detalle_EntradasBrl.CantidadSalida(Me.ID) & " - Saldo :" & Cantidad - Salidas_Detalle_EntradasBrl.CantidadSalida(Me.ID)
            Return wcadena
        End Get
    End Property
	...
	Public Sub Guardar()
		...
		If (Me.ID = Nothing) Then
            ...
            Me.ID = Entradas_DistribucionDAL.Insertar(Id_Entrada_Detalle, Id_Bodega, Cantidad, Id_Capacidad, Observacion, Fecha_Creacion, Id_Usuario_Creacion, Fecha_Modificacion, Id_Usuario_Modificacion, Fecha_Cierre, Cierre)
            RaiseEvent Inserted()			
		Else
            RaiseEvent Updating()		
            Entradas_DistribucionDAL.Actualizar(ID, Id_Entrada_Detalle, Id_Bodega, Cantidad, Id_Capacidad, Observacion, Fecha_Creacion, Id_Usuario_Creacion, Fecha_Modificacion, Id_Usuario_Modificacion, Fecha_Cierre, Cierre)
            RaiseEvent Updated()			
		End If   
        RaiseEvent Saved()
	...
	Public Sub Eliminar()
		...
		If Me.ID <> Nothing Then 
            ...
            Entradas_DistribucionDAL.Eliminar(Me.ID)
            RaiseEvent Deleted()
        End If
	End Sub
