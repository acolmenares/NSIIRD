...
Partial Public Class OrdenCompraBrl
    ...
    Public Shared Function CargarTodos() As List(Of OrdenCompraBrl)

        Dim dsDatos As System.Data.DataSet
        Dim lista As New List(Of OrdenCompraBrl)
        RaiseEvent LoadingOrdenCompraList("CargarTodos")
        dsDatos = OrdenCompraDAL.CargarTodos()
    ...
    Public Shared Function CargarPorAprobarLogOfc(ByVal Numero As String, ByVal Id_Tercero As Int32, ByVal Id_regional As Int32, ByVal Fecha_inicial As String, ByVal Fecha_final As String) As List(Of OrdenCompraBrl)

        Dim dsDatos As System.Data.DataSet
        Dim lista As New List(Of OrdenCompraBrl)
        RaiseEvent LoadingOrdenCompraList("CargarPorAprobarLogOfc")
        dsDatos = OrdenCompraDAL.CargarPorAprobarLogOfc(Numero, Id_Tercero, Id_regional, Fecha_inicial, Fecha_final)
        For Each fila As DataRow In dsDatos.Tables(0).Rows
            lista.Add(asignarValoresALasPropiedades(fila))
        Next
    ...
    Public Shared Function CargarPorAprobarFinOfc(ByVal Numero As String, ByVal Id_Tercero As Int32, ByVal Id_regional As Int32, ByVal Fecha_inicial As String, ByVal Fecha_final As String) As List(Of OrdenCompraBrl)

        Dim dsDatos As System.Data.DataSet
        Dim lista As New List(Of OrdenCompraBrl)
        RaiseEvent LoadingOrdenCompraList("CargarPorAprobarFinOfc")
        dsDatos = OrdenCompraDAL.CargarPorAprobarFinOfc(Numero, Id_Tercero, Id_regional, Fecha_inicial, Fecha_final)
        For Each fila As DataRow In dsDatos.Tables(0).Rows
            lista.Add(asignarValoresALasPropiedades(fila))
        Next
    ...
    Public Shared Function CargarPorAprobarCooLog(ByVal Numero As String, ByVal Id_Tercero As Int32, ByVal Id_regional As Int32, ByVal Fecha_inicial As String, ByVal Fecha_final As String) As List(Of OrdenCompraBrl)

        Dim dsDatos As System.Data.DataSet
        Dim lista As New List(Of OrdenCompraBrl)
        RaiseEvent LoadingOrdenCompraList("CargarPorAprobarCooLog")
        dsDatos = OrdenCompraDAL.CargarPorAprobarCooLog(Numero, Id_Tercero, Id_regional, Fecha_inicial, Fecha_final)
        For Each fila As DataRow In dsDatos.Tables(0).Rows
            lista.Add(asignarValoresALasPropiedades(fila))
        Next
    ...
    Public Shared Function CargarPorAprobarDirOpe(ByVal Numero As String, ByVal Id_Tercero As Int32, ByVal Id_regional As Int32, ByVal Fecha_inicial As String, ByVal Fecha_final As String) As List(Of OrdenCompraBrl)

        Dim dsDatos As System.Data.DataSet
        Dim lista As New List(Of OrdenCompraBrl)
        RaiseEvent LoadingOrdenCompraList("CargarPorAprobarDirOpe")
        dsDatos = OrdenCompraDAL.CargarPorAprobarDirOpe(Numero, Id_Tercero, Id_Tercero, Fecha_inicial, Fecha_final)
        For Each fila As DataRow In dsDatos.Tables(0).Rows
            lista.Add(asignarValoresALasPropiedades(fila))
        Next
    ...
    Public Shared Function CargarPorAprobarDirFin(ByVal Numero As String, ByVal Id_Tercero As Int32, ByVal Id_regional As Int32, ByVal Fecha_inicial As String, ByVal Fecha_final As String) As List(Of OrdenCompraBrl)

        Dim dsDatos As System.Data.DataSet
        Dim lista As New List(Of OrdenCompraBrl)
        RaiseEvent LoadingOrdenCompraList("CargarPorAprobarDirFin")
        dsDatos = OrdenCompraDAL.CargarPorAprobarDirFin(Numero, Id_Tercero, Id_regional, Fecha_inicial, Fecha_final)
        For Each fila As DataRow In dsDatos.Tables(0).Rows
            lista.Add(asignarValoresALasPropiedades(fila))
        Next
    ...
    Public Shared Function CargarPorAprobarCooReg(ByVal Numero As String, ByVal Id_Tercero As Int32, ByVal Id_regional As Int32, ByVal Fecha_inicial As String, ByVal Fecha_final As String) As List(Of OrdenCompraBrl)

        Dim dsDatos As System.Data.DataSet
        Dim lista As New List(Of OrdenCompraBrl)
        RaiseEvent LoadingOrdenCompraList("CargarPorAprobarcooreg")
        dsDatos = OrdenCompraDAL.CargarPorAprobarCooReg(Numero, Id_Tercero, Id_regional, Fecha_inicial, Fecha_final)
        For Each fila As DataRow In dsDatos.Tables(0).Rows
            lista.Add(asignarValoresALasPropiedades(fila))
        Next
    ...
    Public Shared Function CargarPorBusqueda(ByVal Id_Regional As Int32, ByVal Numero As String, ByVal Fecha_Inicial As String, ByVal Fecha_Final As String, ByVal Id_Producto As Integer, ByVal Id_Tercero As Integer) As List(Of OrdenCompraBrl)

        Dim dsDatos As System.Data.DataSet
        Dim lista As New List(Of OrdenCompraBrl)
        RaiseEvent LoadingOrdenCompraList("CargarPorBusqueda")
        dsDatos = OrdenCompraDAL.CargarPorBusqueda(Id_Regional, Numero, Fecha_Inicial, Fecha_Final, Id_Producto, Id_Tercero)
        For Each fila As DataRow In dsDatos.Tables(0).Rows
            lista.Add(asignarValoresALasPropiedades(fila))
        Next
