...
Public Class Entradas_OrdenCompraDAL
    ...
    Public Shared Function Insertar(ByVal Id_Entrada_Detalle As Int32, ByVal Cantidad As Double, ByVal Id_OrdenCompra_Detalle As Int32, ByVal Fecha_Creacion As DateTime, ByVal Id_Usuario_Creacion As Int32, ByVal Fecha_Modificacion As DateTime, ByVal Id_Usuario_Modificacion As Int32, ByVal Fecha_Cierre As DateTime, ByVal Cierre As Boolean) As Int32
    ...
    Public Shared Sub Actualizar(ByVal Id As Int32, ByVal Id_Entrada_Detalle As Int32, ByVal Cantidad As Double, ByVal Id_OrdenCompra_Detalle As Int32, ByVal Fecha_Creacion As DateTime, ByVal Id_Usuario_Creacion As Int32, ByVal Fecha_Modificacion As DateTime, ByVal Id_Usuario_Modificacion As Int32, ByVal Fecha_Cierre As DateTime, ByVal Cierre As Boolean)
