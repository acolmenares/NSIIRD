...
Public Class EntradasDAL
    ...
    Public Shared Function Insertar(ByVal Id_Tipo_Entrada As Int32, ByVal Id_Tercero As Int32, ByVal Numero_Entrada As String, ByVal Numero_Factura_Proveedor As String, ByVal Fecha As DateTime, ByVal Id_Regional As Int32, ByVal Id_Regional_Envia As Int32, ByVal Id_Usuario_Recibio As Int32, ByVal Nombre_Entrego As String, ByVal Identificacion_Entrego As String, ByVal Observacion As String, ByVal Fecha_Creacion As DateTime, ByVal Id_Usuario_Creacion As Int32, ByVal Fecha_Modificacion As DateTime, ByVal Id_Usuario_Modificacion As Int32, ByVal id_salida_traslado As Int32, ByVal Fecha_Cierre As DateTime, ByVal Cierre As Boolean) As Int32
        Return SqlHelper.ExecuteScalar(strCadenaConexion, "dbo.EntradasInsertar", isNothingToDBNull(Id_Tipo_Entrada), isNothingToDBNull(Id_Tercero), isNothingToDBNull(Numero_Entrada), isNothingToDBNull(Numero_Factura_Proveedor), isNothingToDBNull(Fecha), isNothingToDBNull(Id_Regional), isNothingToDBNull(Id_Regional_Envia), isNothingToDBNull(Id_Usuario_Recibio), isNothingToDBNull(Nombre_Entrego), isNothingToDBNull(Identificacion_Entrego), isNothingToDBNull(Observacion), isNothingToDBNull(Fecha_Creacion), isNothingToDBNull(Id_Usuario_Creacion), isNothingToDBNull(Fecha_Modificacion), isNothingToDBNull(Id_Usuario_Modificacion), isNothingToDBNull(id_salida_traslado), isNothingToDBNull(Fecha_Cierre), isNothingToDBNull(Cierre))
    End Function

    Public Shared Sub Actualizar(ByVal Id As Int32, ByVal Id_Tipo_Entrada As Int32, ByVal Id_Tercero As Int32, ByVal Numero_Entrada As String, ByVal Numero_Factura_Proveedor As String, ByVal Fecha As DateTime, ByVal Id_Regional As Int32, ByVal Id_Regional_Envia As Int32, ByVal Id_Usuario_Recibio As Int32, ByVal Nombre_Entrego As String, ByVal Identificacion_Entrego As String, ByVal Observacion As String, ByVal Fecha_Creacion As DateTime, ByVal Id_Usuario_Creacion As Int32, ByVal Fecha_Modificacion As DateTime, ByVal Id_Usuario_Modificacion As Int32, ByVal Id_Salida_Traslado As Int32, ByVal Fecha_Cierre As DateTime, ByVal Cierre As Boolean)
        SqlHelper.ExecuteNonQuery(strCadenaConexion, "dbo.EntradasActualizar", Id, isNothingToDBNull(Id_Tipo_Entrada), isNothingToDBNull(Id_Tercero), isNothingToDBNull(Numero_Entrada), isNothingToDBNull(Numero_Factura_Proveedor), isNothingToDBNull(Fecha), isNothingToDBNull(Id_Regional), isNothingToDBNull(Id_Regional_Envia), isNothingToDBNull(Id_Usuario_Recibio), isNothingToDBNull(Nombre_Entrego), isNothingToDBNull(Identificacion_Entrego), isNothingToDBNull(Observacion), isNothingToDBNull(Fecha_Creacion), isNothingToDBNull(Id_Usuario_Creacion), isNothingToDBNull(Fecha_Modificacion), isNothingToDBNull(Id_Usuario_Modificacion), isNothingToDBNull(Id_Salida_Traslado), isNothingToDBNull(Fecha_Cierre), isNothingToDBNull(Cierre))
    End Sub
    ...
    Public Shared Function CargarPorId_Tercero(ByVal Id_Tercero As System.Int32) As System.Data.DataSet
        Return SqlHelper.ExecuteDataset(strCadenaConexion, "dbo.EntradasConsultarPorId_Tercero", Id_Tercero)
    End Function
