...
Namespace BindHelper
    ...
    Partial Public NotInheritable Class OrdenCompra_DetalleUIL
        ...
        Public Shared Function BindToListControl(ByVal control As ListControl, Optional ByVal firstItem As ListItem = Nothing) As List(Of OrdenCompra_DetalleBRL)
            Dim Lista As List(Of OrdenCompra_DetalleBRL)
            Lista = OrdenCompra_DetalleBRL.CargarTodos()
